...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="<?php echo base_url();?>" title="返回仪表盘" class="tip-bottom"><i class="icon-home"></i> 仪表盘</a> <a href="/activity">活动管理</a> <a href="javascript:;">添加活动</a></div>
    <h1>添加活动</h1>
  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="/activity/do_add" name="adminAddForm" id="adminAddForm" onSubmit="return Validator.Validate(this, 3)">
              <div class="control-group">
                <label class="control-label">活动名称</label>
                <div class="controls">
                  <input type="text" name="title" dataType="Require" msg=" 活动名称不能为空！">
                </div>
              </div>

                <div class="control-group">
                    <label class="control-label">活动图片</label>
                    <input type="hidden" name="game_img" id="img_url" value=""  dataType="Require" msg=" 活动图片不能为空！" />
                    <div class="controls" style="float:left; margin-left:22px;" >
                        <img src="/static/img/image_default.png " width="180px" height="180px">
                ...
                <div class="controls">
                  <textarea rows="6" class="span8" placeholder="活动正文" name="content" dataType="Require" msg=" 活动图片不能为空！" ></textarea>
                </div>
              </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <input type="text" style="width:135px;" id="end_time" class="n_input four_input" name="end_time"
                               value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',minDate:'%y-%M-%d %H:%m'})"  dataType="Require" msg=" 截止日期不能为空！" >
                    </div>
                </div>

              <div class="form-actions">
                <button type="submit" class="btn btn-success">保存</button> <button class="btn" onclick="window.location.href='/activity/add'">取消</button>
              </div>
            </form>
          </div>
        </div>
