...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="<?php echo base_url(); ?>" title="返回仪表盘" class="tip-bottom"><i class="icon-home"></i>仪表盘</a> <a href="javascript:;">系统设置</a> <a href="/config">配置管理</a> <a href="javascript:;">添加配置</a></div>
        <h1>添加配置</h1>
    </div>
            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" action="/config/do_add" name="configAddForm" id="configAddForm" onSubmit="return Validator.Validate(this, 3)">
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-success">保存</button> <a class="btn" href="/config/add">取消</a>
                    </div>
                    </form>
                </div>
            </div>
